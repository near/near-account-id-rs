...
- add typed universal account IDs ([#63](https://github.com/near/near-account-id-rs/pull/63))

### Other

- fix AccountId link in re-exports ([#64](https://github.com/near/near-account-id-rs/pull/64))
